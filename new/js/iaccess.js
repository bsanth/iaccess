...
function readNavigation(n) {
	...
	document.getElementById("voiceDiv").innerHTML="<EMBED runat='server' src='http://translate.google.com/translate_tts?tl=en&q=link+"+navigation.links.eq(n).html()+"' hidden='true' volume='100' loop='FALSE' autostart='true'></EMBED>";
...
function readContent(n) {
	...
	document.getElementById("voiceDiv").innerHTML="<EMBED runat='server' src='http://translate.google.com/translate_tts?tl=en&q="+content.items.eq(n).html()+"' hidden='true' volume='100' loop='FALSE' autostart='true'></EMBED>";
